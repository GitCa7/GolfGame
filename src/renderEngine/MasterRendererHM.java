...
public class MasterRendererHM {
    ...
    private TerrainRendererHM terrainRenderer;
    private terrainShader terraShader = new terrainShader();
     
     
    private Map<TexturedModel,List<Entity>> entities = new HashMap<TexturedModel,List<Entity>>();
    private List<Terrain2> terrains = new ArrayList<Terrain2>();
     
    private SkyboxRenderer skyboxRenderer;
    
    public MasterRendererHM(Loader loader){
        enableCulling();
        createProjectionMatrix();
        renderer = new EntityRenderer(shader,projectionMatrix);
        terrainRenderer = new TerrainRendererHM(terraShader,projectionMatrix);
    ...
    public void processTerrain(Terrain2 terrain){
